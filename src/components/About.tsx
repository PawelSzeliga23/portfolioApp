...
const About: React.FC = () => {
    ...
    return (
        <div>
            ...
            {isMobile &&
                <div className="pt-20 max-sm:pt-0 gap-5 flex flex-col ml-2 mr-2 mb-10">
                    <div className='flex flex-col items-center justify-center bg-white z-50 md:w-180 lg:w-260 sm:w-140 mx-auto max-sm:mx-1 dark:bg-gray-800 p-5 rounded-lg shadow-lg'>
                        <h1 className="text-2xl font-bold mb-4 dark:text-white">{t('about.sections.Education')}</h1>
                        <p>
                            {t('about.paragraphs.Education1')}
                            <br /><br />
                            {t('about.paragraphs.Education2')}
                    ...
                    <div className='flex flex-col items-center justify-center bg-white z-50 md:w-180 lg:w-260 sm:w-140 mx-auto max-sm:mx-1 dark:bg-gray-800 p-5 rounded-lg shadow-lg'>
                        <h1 className="text-2xl font-bold mb-4 dark:text-white">{t('about.sections.Experience')}</h1>
                        <p>
                            {t('about.paragraphs.Experience1')}
                            <br /><br />
                            {t('about.paragraphs.Experience2')}
                    ...
                    <div className='flex flex-col items-center justify-center bg-white z-50 md:w-180 lg:w-260 sm:w-140 mx-auto max-sm:mx-1 dark:bg-gray-800 p-5 rounded-lg shadow-lg overflow-hidden'>
                        <h1 className="text-2xl font-bold mb-4 dark:text-white">{t('about.sections.Skills')}</h1>
                    ...
                    <div className='flex flex-col items-center justify-center bg-white z-50 md:w-180 lg:w-260 sm:w-140 mx-auto max-sm:mx-1 dark:bg-gray-800 p-5 rounded-lg shadow-lg'>
                        <h1 className="text-2xl font-bold mb-4 dark:text-white">{t('about.sections.Interests')}</h1>
                        <p>
                            {t('about.paragraphs.Interests1')}
                            <br /><br />
                            {t('about.paragraphs.Interests2')}
