...
const About: React.FC = () => {
    ...
    return (
        <div className='mt-20 flex flex-col items-center justify-center bg-white z-50 mx-60'>
            <div className="flex w-full justify-between mx-52 border-2 border rounded bg-white space-x-0">
                ...
                <motion.div
                    key={activeSection}
                    className="w-full h-500 bg-white border-2 border rounded shadow-lg overflow-hidden"
