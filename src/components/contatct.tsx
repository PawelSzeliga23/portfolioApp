        ...
        <div className="pt-20">
            <div className="max-w-4xl mx-auto  p-8 bg-white rounded-xl shadow-lg flex flex-col md:flex-row gap-8 dark:bg-gray-800 ">
                <div className="md:w-1/2 flex flex-col justify-center mb-8 md:mb-0 ">
                    <h2 className="text-3xl font-bold mb-6 text-gray-800 flex items-center h-[56px] dark:text-gray-100">Contact Info</h2>
                ...
                <div className="md:w-1/2 flex flex-col justify-center mb-8 md:mb-0">
                    <h2 className="text-3xl font-bold mb-6 text-center text-gray-800 flex items-center h-[56px] dark:text-gray-100">Contact Me</h2>
                    {submitted ? (
